...
const controllers = {
    ...
    options: (req, res, tokens) => {
        ...
        headers["Access-Control-Allow-Origin"] = "*";
        headers["Access-Control-Allow-Headers"] = "X-Requested-With, X-HTTP-Method-Override, Content-Type, Access-Control-Allow-Headers";
...
server.listen(7000);
console.log('Server started on port 7000. You can make requests to http://localhost:7000/');